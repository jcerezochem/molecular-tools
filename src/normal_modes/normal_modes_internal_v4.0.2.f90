program normal_modes_animation
    ...
    !v4.0.2:
    ! -Custom internal coordinates (requires a generic internal2cartesian generator, beyond z-mat). Under constructruction
    !  >>> OUT OF TRACK (do not include modifications in v4.0.1.1 and derivatives)
    !
    !============================================================================    
...
!==================================================================================
    ...
    elseif (custom_int) then
        print*, "Custom internal coordinates"
