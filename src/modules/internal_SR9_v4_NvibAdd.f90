...
subroutine internal_Wilson(molec,Nvib,S,S_sym,ModeDef,B,G,Asel,verbose)
...
! print*, i, "X0+d", molecB%atom(i)%x
        ...
        call internal_Wilson(molecB,Nvib,S,S_sym,ModeDef,Bplus,G,Asel,verbose)
        molecB%atom(i)%x = molec%atom(i)%x - delta
! print*, i, "X0-d", molecB%atom(i)%x
        !Call B matrix at this geometry   
        call internal_Wilson(molecB,Nvib,S,S_sym,ModeDef,Bmin,G,Asel,verbose)
