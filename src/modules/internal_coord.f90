module internal_module
    ...
    !==============================================================
    ! Description
    !  This MODULE contains subroutines to get work with internal
    !   coordinates (tidy version..)
    !    
    !==============================================================
    ...
    contains
        ...
        subroutine internal_Wilson(nbonds,nangles,ndihed,nimprop, & 
                                   bond,angle,dihed,improp,    &
                                   S,B,verbose)
        ...
        !==============================================================
        ! Description
        !  Performs vibrational analysis using ghe Wilson B matrix and 
        !   the GF method.
        !
        ! Arguments
        !==============================================================
        ...
        integer,dimension(:,:),intent(in) :: bond,angle,dihed,improp
        real(8),dimension(:),intent(in) :: S 
        real(8),dimension(NDIM,NDIM),intent(out) :: B 
        ...
        !====================== 
        !AUXILIAR MATRICES FOR WDC FORMULAS
