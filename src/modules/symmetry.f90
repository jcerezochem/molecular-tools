...
!                  return
    ...
    subroutine symm_atoms_v2(molec,isym_v2,nsym_ops,Osym,rotate)
        ...
        !System variables
        type(str_resmol),intent(inout)     :: molec
        integer,dimension(:,:),intent(out) :: isym_v2
        integer,intent(out)                :: nsym_ops
