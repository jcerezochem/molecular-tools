module internal_module
 ...
 ! Version 5: str_residue replaced by str_system. V4 with general clean up
 ...
 !            Include readZ SR
 ! Version 8_corrected: bugfix B matrix element for dihedral
 ! Version 8.2: manage colinear atoms within Z-mat generation
 ! Version 8.4_corrected: 
...
subroutine build_Z(molec,bond_s,angle_s,dihed_s,PG,isym,bond_sym,angle_sym,dihed_sym)
    ...
    !Otra posibilidad es correr por las conexiones "cerrando" los pasos con un indentificador
...
subroutine internal_Wilson(molec,S,S_sym,ModeDef,B,G,Asel,verbose)
    ...
    !ARGUMENTS
    !Input
    type(str_system),intent(in) :: molec            ! Input molecule to which the vib analysis is performed
...
subroutine internal_fc(Hess,molec,S_sym,ModeDef,B,G,verbose)
    ...
    !ARGUMENTS
    !Inpu
    type(str_system),intent(in) :: molec                     !Input molecule
...
subroutine axis_swithching(molec,molec2,T0)
    ...
    type(str_system),intent(in)    :: molec
    type(str_system),intent(inout) :: molec2 
    real(8),dimension(3,3)          :: T0

    !Local
    type(str_system)   :: molec_aux
...
subroutine check_ori2(molec,molec2)
    ...
    type(str_system),intent(inout) :: molec
    type(str_system),intent(in)    :: molec2
...
subroutine check_Ci(molec,molecP,molec2)
    ...
    type(str_system),intent(inout) :: molec
    type(str_system),intent(in)    :: molec2, molecP
